...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.POST, "/usuarios/logar").permitAll() //Libera os endpoints usuários/logar
        .antMatchers(HttpMethod.POST,"/usuarios/cadastrar").permitAll() //Libera os endpoints usuários/cadastrar
